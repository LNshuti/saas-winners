...
Where:
- $ Z_{\alpha/2} $ = Z-value for the desired significance level (1.96, corresponding to a 5% significance level)
- $ Z_{\beta} $ = Z-value for the desired power (0.84, corresponding to 80% power)
